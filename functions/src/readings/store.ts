...
/**
 * A reading as the API returns it.
 *
...
export interface ReadingDTO {
  id: string;
  bookId: string;
  /** Legacy denormalized field, kept for pre-migration readings. */
  bookTitle?: string;
  /** Legacy denormalized field, kept for pre-migration readings. */
  bookAuthor?: string;
  tiles: string[];
...
export function toReading(doc: QueryDocumentSnapshot): ReadingDTO {
